...
export default function Blogs_section() {
  ...
  return (
    <div className="w-full relative mt-10 lg:mt-28">
      <div className="container_1 mt-10 lg:mt-28 w-full flex flex-col items-center justify-between sticky top-1/2 bottom-1/2 m-auto ">
