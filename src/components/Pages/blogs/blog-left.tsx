...
export default function Blogs_2() {
  return (
    <>
      {/*===== PRELOADER STARTS =======*/}
              ...
              <div className="blog-sidebar-area">
                ...
                <div className="posts-area">
                  ...
                  <div className="post-auhtor-area box2">
                    ...
                    <div className="content">
                      ...
                      <a href="#" className="head">
                        The Power of Content Marketing How to Drive...{" "}
                      </a>
                    </div>
                  </div>
                  <div className="post-auhtor-area">
                    ...
                    <div className="content">
                      ...
                      <a href="#" className="head">
                        The Power of Social Media Marketing: How to Build
                        Your...
                      </a>
                    </div>
                  </div>
                  <div className="post-auhtor-area">
                    ...
                    <div className="content">
                      ...
                      <a href="#" className="head">
                        Social Media Marketing Strategies Drive Engagement..
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="others-area">
                  ...
                  <div className="btn-area">
                    <a href="tel:123-456-7890" className="header-btn1">
                      123-456-7890{" "}
                      <span>
                        <i className="fa-solid fa-arrow-right" />
                      </span>
