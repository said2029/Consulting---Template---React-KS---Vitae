          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4">
              <div className="works-header-area heading2 specing2">
                ...
                <p>
                  We develop customized email marketing strategies that align
                  with your business goals and target audience. We segment your
                  email list to ensure that your messages are relevant
                  personalized for different audience groups.
                </p>
                <div className="space16" />
                <p>
                  We create a comprehensive content calendar to schedule and
                  plan your email campaigns effectively.
                </p>
              </div>
            </div>
            <div className="col-lg-1" />
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4">
              <div className="works-header-area heading2">
                ...
                <p>
                  We design and develop responsive email templates that look
                  great on all devices, ensuring seamless experience.
                </p>
                <div className="space16" />
                <p>
                  We create visually appealing emails that reflect your brand's
                  identity and capture your audience's attention.
                </p>
              </div>
            </div>
            <div className="col-lg-6">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4">
              <div className="works-header-area heading2 specing2">
                ...
                <p>
                  We craft compelling email copy that resonates with your
                  audience and drives action. We include relevant images,
                  videos, and other media to enhance your emails and keep them
                  visually appealing.
                </p>
                <div className="space16" />
                <p>
                  We create informative and engaging content that adds value to
                  your subscribers and encourages them to stay connected.
                </p>
              </div>
            </div>
            <div className="col-lg-1" />
